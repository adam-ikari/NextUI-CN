...
typedef struct
{
	...
	int version; // settings file version for migration (following libmsettings pattern)
...
#define CFG_DEFAULT_FONT_ID 0  // font1.ttf (first font)
